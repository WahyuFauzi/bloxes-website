	...
	return (
		<>
			<Layout>
				<div
					role="login-card"
					className="p-4 max-w-sm bg-primary text-white mx-auto my-4 rounded-lg border border-gray-200 shadow-md sm:p-6 lg:p-8 dark:bg-gray-800 dark:border-gray-700"
				>
